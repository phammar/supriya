...
- Put the mi-UGens directory extracted from the download binaries in your in Extensions
  dir (`Platform.userExtensionDir`)
...
Configure SuperCollider - edit your startup.scd: Linux:
~/.conf/SuperCollider/startup.scd
